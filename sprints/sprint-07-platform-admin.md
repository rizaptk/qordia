...
- [ ] **Tenant Management Module (`/platform/tenants`):**
    ...
    - [ ] **Creation Form:** Implement a form/dialog to register a new tenant. This should create a new document in the `/tenants` collection.
...
- [ ] **Navigation & Links:**
    - [ ] Add links for "Tenants", "Monitoring", and "Billing" to the platform admin sidebar.
    - [ ] Use appropriate icons from `lucide-react` (e.g., `Building`, `Server`, `CreditCard`).
